...
namespace FrbaOfertas
{
    public partial class ComprarOferta : Form
    {
        ...
        private void ComprarOferta_Load(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("Select ofer_id, ofer_descripcion,ofer_fecha_vencimiento,ofer_precio_oferta,p.prov_razon_social from SOCORRO.Oferta o join SOCORRO.Proveedor p on o.ofer_prov_id = p.prov_id  where p.prov_habilitado=1 and o.ofer_fecha_vencimiento>@fecha and o.ofer_stock>0", conexion);
